...
const schemaAddEdit = yup
  .object({
    Title_1: yup.string().required('Vui lòng nhập tên phụ phí'),
    DynamicID_1: yup.string().required('Vui lòng nhập mã phụ phí')
  })
  .required()
...
function PickerAddEdit({ children, initialValues }) {
  ...
  useEffect(() => {
    if (initialValues) {
      ...
      setValue('Title_1', initialValues?.Title_1 || '')
      setValue('DynamicID_1', initialValues?.DynamicID_1 || '')
      setValue(
        'Type',
        initialValues?.Type
  ...
  let initialMaterials = useQuery({
    ...
    onSuccess: data => {
      if (data?.DynamicID_1) {
        setValue('DynamicID_1', data?.DynamicID_1)
      }
    },
  ...
  let initialMaterialsID = useQuery({
    ...
    onSuccess: data => {
      if (data) {
        ...
        let BonusSaleJSON_1 = data?.BonusSaleJSON_1
  ...
  let { BonusSaleJSON_1, _USERLEVEL } = watch()
                            ...
                            <div>
                                        ...
                                        >
                                          {({ open }) => (
                                            <SelectCategoryProds
                                              ...
                                              menuPortalTarget={document.body}
                                              placeholder="Chọn nhóm phụ phí"
                                              noOptionsMessage={() =>
                                                'Chưa có nhóm phụ phí.'
                                              }
                              ...
                              <div className="pt-5 border-t mt-7 border-t-separator">
                                ...
                                <div>
                                  ...
                                  <div className="grid grid-cols-1 gap-4 mb-4 last:mb-0 sm:grid-cols-2">
                                    <div>
                              ...
                              <div className="pt-5 border-t mt-7 border-t-separator">
                                <div className="mb-4">
                                  ...
                                  <div className="font-light text-muted2">
                                    Cài đặt giá trị lương của phụ phí mà nhân
                                    viên được hưởng.
                                  </div>
                                </div>
                                <div className="mb-4">
                                  <div>
                                    {_USERLEVEL && _USERLEVEL.length > 0 ? (
                                      <div className="grid grid-cols-1 gap-4">
                                        {fieldsUserLevel &&
                                  ...
                                  <div className="flex items-center justify-between mt-3">
                                    <div className="pr-4 font-light text-muted2">
                                      Chọn Switch để cài đặt lương khác nhau cho
                                      từng cấp bậc
                                    </div>
                                        ...
                                        >
                                          ...
                                          <div className="pl-3">
                                            ...
                                            <div className="text-[#727373] font-light text-[14px]">
                                              Bỏ tích này phụ phí sẽ không được
                                              hiển thị.
                                            </div>
                                          </div>
                                        </label>
                                      ...
                                      render={({
                                        ...
                                        >
                                          ...
                                          <div className="pl-3">
                                            ...
                                            <div className="text-[#727373] font-light text-[14px]">
                                              Bỏ tích này phụ phí sẽ hiện thị
                                              giá liên hệ.
                                            </div>
                                          </div>
                                        </label>
