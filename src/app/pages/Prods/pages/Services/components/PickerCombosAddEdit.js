...
function PickerCombosAddEdit({ children, initialValues }) {
  ...
  const { fields: fieldsUserLevel } = useFieldArray({
    control,
    name: '_USERLEVEL'
  })
  ...
  let initialServices = useQuery({
    queryKey: ['initialServices', { MenuActive }],
    queryFn: async () => {
      let dataPost = {
        id: 0,
        '[Title]': '',
  ...
  let initialServicesID = useQuery({
    queryKey: ['initialServicesID', initialValues],
    queryFn: async () => {
  ...
  const LevelsMaterials = useQuery({
    ...
    queryFn: async () => {
      const { data } = await ProdsAPI.getLevelProdId(initialValues?.ID || 0)
      return {
    ...
    onSuccess: ({ ul }) => {
      if (initialValues?.ID && ul && ul.length > 0) {
        setValue('_USERLEVEL', ul)
      }
    },
    enabled: visible
  })
  ...
  const onSubmit = values => {
    let newValues = {
      ...
      Type: values?.Type?.value || MenuActive?.ID,
      Types: MenuActive?.ID,
  ...
  let { BonusSaleJSON, id, Combo, CostBaseOption, _USERLEVEL } = watch()
      ...
      {visible && (
        <FloatingPortal root={document.body}>
          <FormProvider {...methods}>
            ...
            >
              <div className="flex justify-between p-4 sm:px-8 sm:py-6">
                ...
                <div className="hidden gap-3 sm:flex">
                  ...
                  {activeStep === 0 && (
                    <Button
                      ...
                      onClick={() => {
                        if (Combo.some(x => !x.Id)) {
                          for (let [index, value] of Combo.entries()) {
                            if (!value.Id) {
                              setError(`Combo[${index}].Id`, {
                                type: 'Client'
                              })
                            }
                          }
              ...
              <div className="relative h-[3px] min-h-[3px] bg-gray-200 w-full">
                <div
              ...
              {(
                initialValues?.ID
                  ? initialServicesID?.isLoading
                  : initialServices?.isLoading
              ) ? (
                ...
                <div
                  className="relative overflow-auto grow lg:py-10 sm:p-4"
                  ref={elRef}
                >
                  {activeStep === 0 && (
                    <div>
                      <div className="max-w-[800px] w-full mx-auto">
                        <div>
                          {fieldsCombos &&
                            fieldsCombos.map((item, i) => (
                              <div
                                className="border border-[#e5e5e5] rounded-lg mb-4 last:mb-0"
                                key={item.id}
                              >
                                        ...
                                        <SelectProdsCombos
                                          ...
                                          onChange={val => {
                                            if (fieldState.invalid) {
                                              clearErrors(`Combo[${i}].Id`)
                                            }
                                            field.onChange(val)
                                            if (val) {
                                              setValue(`Combo[${i}].qty`, 1)
                                              if (val?.suffix === 'DV') {
                                                setValue(
                                                  `Combo[${i}].isService`,
                                                  1
                                              ...
                                              setValue(`Combo[${i}].qty`, '')
                                              setValue(`Combo[${i}].price`, '')
                                              setValue(
                                                `Combo[${i}].isService`,
                                                0
                                              )
                                              ...
                                              setValue(`Combo[${i}].addfee`, '')
                                              setValue(`Combo[${i}].baohanh`, {
                                                bh: false,
                                                luong_bh: '',
                                                tg_bh: '-1',
                                                slg_bh_toi_da: '-1',
                        ...
                        <div className="mt-6">
                          ...
                          >
                            ...
                            <span className="pl-1.5">Thêm mới Combo</span>
                          </button>
                        </div>
                      </div>
                    </div>
                                  ...
                                  <div>
                                    ...
                                    <div className="pt-5 border-t mt-7 border-t-separator">
                                      <div className="mb-4">
                                        ...
                                        <div className="font-light text-muted2">
                                          Cài đặt thông tin giá cost, giá bán
                                          của mặt hàng.
                                        </div>
                                      </div>
                                      <div>
                                    ...
                                    <div className="pt-5 border-t mt-7 border-t-separator">
                                      <div className="mb-4">
                                        ...
                                        <div className="font-light text-muted2">
                                          Cài đặt giá trị hoa hồng của mặt hàng
                                          mà nhân viên được hưởng.
                                        </div>
                                      </div>
                                      <div className="mb-4">
                                        <div>
                                            ...
                                            onChange={e => {
                                              if (
                                                ...
                                                if (e) {
                                                  setValue(
                                                    'BonusSaleJSON',
                                                    LevelsMaterials?.data?.Levels.map(
                                                      x => ({
                                                        Level: x,
                                                        Salary: ''
                                                      })
                                              ...
                                              <Tooltip
                                                ...
                                                overlay={
                                                  <div className="px-3 py-2.5 bg-white dark:bg-dark-light rounded-sm shadow-lg text-gray-700 dark:text-graydark-800 max-w-[300px] text-center">
                                                    Trường hợp KH mới - nhân
                                                    viên tư vấn sẽ được % cao
                                                    hơn bạn sẽ setup mức hoa
                                                    hồng khách mới
                                                  </div>
                                                }
                                                align={{
                                    ...
                                    <div className="pt-5 border-t mt-7 border-t-separator">
                                      <div className="mb-4">
                                        ...
                                        <div className="font-light text-muted2">
                                          Cài đặt giá trị lương của phụ phí mà
                                      ...
                                      <div className="mb-4">
                                        ...
                                        <div className="flex items-center justify-between mt-3">
                                          <div className="pr-4 font-light text-muted2">
                                            Chọn Switch để cài đặt lương khác
                                            nhau cho từng cấp bậc
                                          </div>
                            ...
                            <Tab.Panel>
                              <div>
                                <div className="mb-6">
                                  ...
                                  <div className="font-light text-muted2">
                                    Encourage clients to book additional
                                    services and buy suitable memberships when
                                    booking online. Manage your workspace
                              ...
                              <>
                                <Tab.Panel>
                                  <div className="mb-6">
                                    ...
                                    <div className="font-light text-muted2">
                                      Cài đặt các thông tin hiển thị trên
                                      Website, App, Zalo App
                                    </div>
                                  </div>
                                  <div className="mb-6">
                                    <div className="mb-4 last:mb-0">
...
export default PickerCombosAddEdit
