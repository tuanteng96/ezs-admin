      ...
      <div className="flex flex-col h-full px-8 pt-8 pb-5 mx-auto max-w-7xl">
        ...
        >
          ...
          <div className="flex justify-between pt-6">
            <div>
              <div className="flex border border-[#e6e7eb] h-11 rounded">
                <div className="flex items-center px-4 min-w-[200px]">
                  {fields && fields.length > 0 && <>{fields.length} hình ảnh</>}
                  {(!fields || fields.length === 0) && 'No File Chosen'}
                </div>
                <div className="bg-[#f3f3f3] px-4 flex items-center relative">
            ...
            <div>
              <Button
                ...
                disabled={allMutation.isLoading || initialMutation.isLoading}
                type="submit"
