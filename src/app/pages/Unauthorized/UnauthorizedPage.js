...
function UnauthorizedPage(props) {
  return (
    <div className="w-full h-full relative">
      <img
        src="https://preview.keenthemes.com/metronic8/demo1/assets/media/auth/bg1.jpg"
        alt="Not have access"
      ...
      <div className="bg-white shadow-lg rounded max-w-2xl w-full absolute top-2/4 left-2/4 -translate-x-2/4 -translate-y-2/4 pt-20 pb-10 px-10 flex flex-col justify-center items-center">
        <div className="font-inter text-2xl font-bold mb-3">
        ...
        <div className="max-w-[300px]">
          <img
            className="w-full"
            src="https://preview.keenthemes.com/metronic8/demo1/assets/media/auth/membership.png"
            alt=""
          />
        </div>
      </div>
