...
const UploadAvatar = ({
  ...
  return (
    <>
      <div
        className={clsx(
          'w-[176px] h-[176px] shadow-sm rounded-full relative bg-primarylight'
        )}
      >
        {/* No file */}
        <div
          className={clsx(
            'relative flex flex-col items-center justify-center h-full text-center border rounded-full',
            errorMessageForce ? 'border-danger' : 'border-transparent'
          )}
        >
        ...
        {value && (
          <div className="absolute top-0 left-0 w-full h-full">
            <a
              className="flex items-center justify-center h-full overflow-hidden rounded-full"
            ...
            <div
              className="absolute z-10 flex items-center justify-center transition bg-white rounded-full shadow-lg cursor-pointer dark:text-darkgray-800 dark:bg-graydark-200 h-8 w-8 -top-[2%] -right-[-8%] hover:text-primary"
              onClick={() => onChange('')}
            >
        ...
        <div
          className={clsx(
            'absolute top-0 right-0 flex items-center justify-center w-full h-full bg-gray-300 dark:bg-dark-app/90 z-10 transition rounded-full',
